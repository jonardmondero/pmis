    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark weight-3">HOLIDAYS</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <h4 id="notification_message">The System is reflecting the Holiday. Please wait.</h4>
            </div>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-4">
              ...
              <div class="card-title "><b>HOLIDAY INFO</b></div>
                </div>
                <div class="card-body">
                  <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF");?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" data-provide="datepicker" autocomplete="off" name="date"
                    ...
                    <div class="row" style="margin-top:10px;">
                      <button type="submit" name="save_holiday" class="  btn bg-dark m-auto font-bold"><b>SAVE</b></button>
                    </div>
                    <?php if ($alert == "true") {?>
            ...
            <div class="col-8 pull-right ">
              <div class="card">
                <div class="card-header bg-dark">
                  <div class="card-title"><b>LIST OF HOLIDAYS</b></div>
                </div>
                <div class="card-body">
                  ...
                  <table id="users" class="table table-bordered  table-hover ">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button class="btn btn-success btn-xs" id="approveHoliday"><i
                            class="fa fa-check-square-o"></i>
                        </button>
                        &nbsp;
                        <button class="btn btn-danger btn-xs" data-role="confirm_delete"
                          id="remove_holiday"><i class="fa fa-trash-o"></i></button>
