...
//select the employees in the selected department
  ...
  if($_SESSION['currentGeneration'] == '' || $_SESSION['currentGeneration'] != $seldep){ //CHECK IF THE DEPARTMENT IS NOT CURRENTLY GENERATED BY OTHER USERS.

    $_SESSION['currentGeneration'] = $seldep; // SET THE SESSION INTO CURRENT DEPARTMENT
 ...
 $dateto= strtotime($_POST['dateto']);
    $timeIn = $_POST['cst_chkin'];
    $brkout = $_POST['cst_brkout'];
...
echo "Congratulations you successfully imported the selected department.";
  ...
  echo "This department is currently generated by other user!";
}
