...
DECLARE checktimeoutPM  VARCHAR(50);
SELECT undertime,outPM INTO morning,checktimeoutPM FROM dailytimerecord WHERE employeeNo = empno AND DATE = ddate LIMIT 1;
